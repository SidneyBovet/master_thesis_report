...
\keywords{Vitual reality, Embodiment, Retargeting, Motion capture} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
