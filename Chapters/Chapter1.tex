...
One key factor of the SoE is the \textbf{Sense of Agency}. It is defined by Tsakiris et al.\ \cite{tsakiris2006having} as ``the sense of intending and executing actions, including the feeling of controlling one’s own body movements, and, through them, events in the external environment.'' It is therefore closely linked to our research topic, given that we aim to change the way one interacts with a virtual environment by distorting the movements of the virtual body. We are therefore acting directly on one of the basis of the Sense of Agency.
